...
import logo from '../assets/career-corner-logo.jpg'
    ...
    return (
        <div className = "flex justify-between py-6 px-[100px] bg-red">
            ...
            <div className = " text-md font-semibold flex text-black  gap-16 items-center">
                ...
                <ul className = "hover:text-gray-100 hover:cursor-pointer">CONTACT US</ul>
                {/* <button className = "bg-buttonColor text-black rounded-md h-10 w-28 font-semibold text-lg">Login</button> */}
                
            </div>
        </div>
    //     <div className = "flex justify-between py- h-[16vh] bg-green px-4 items-center">
    //     <div className='w-[10%]'>
    //     <img src = {logo} alt = "search" className=' w-full h-full shadow-2xl shadow-gray-800' />
    //     </div>
    //     <div className='flex justify-evenly w-[80%]'>
    //        {/* {isMediaMax1025px ? (
    //         <div className='flex w-full justify-end'>
    //        <img src={hamburgerIcon} alt='' onClick={()=>{setSideMenu(!sideMenu)}}/>
    //         </div>
    //        ):
    //        ( 
    //         <> */}
    //         <div className = "hover:text-gray-100 hover:cursor-pointer">OUR PROGRAMS</div>   
    //          <div className = "hover:text-gray-100 hover:cursor-pointer">OUR STORY</div>
    //          <div className = "hover:text-gray-100 hover:cursor-pointer">OUR BRANDS</div>
    //          <div className = "hover:text-gray-100 hover:cursor-pointer">SOCIAL INITIATIVES</div>
    //          <div className = "hover:text-gray-100 hover:cursor-pointer">CONTACT US</div>
    //         {/* </>)} */}
    //     </div>
    //     {/* <Slide direction='left' in={sideMenu}>
    //         <div className='h-[100vh] shadow-lg right-0 top-[12px] bg-white p-4 absolute w-[60vw] z-[99999]  flex flex-col'>
    //             <img src= {crossIcon} alt='' className='w-[10px] h-[10px]' onClick={()=>{setSideMenu(false)}}/>
    //             <div className = "hover:text-gray-100 hover:cursor-pointer">OUR PROGRAMS</div>   
    //          <div className = "hover:text-gray-100 hover:cursor-pointer">OUR STORY</div>
    //          <div className = "hover:text-gray-100 hover:cursor-pointer">OUR BRANDS</div>
    //          <div className = "hover:text-gray-100 hover:cursor-pointer">SOCIAL INITIATIVES</div>
